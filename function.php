...
function tambah($data)
{
    ...
    $sql = "INSERT INTO siswa VALUES ('$nis','$Merk','$tmpt_Lahir','$tgl_Lahir','$jekel','$Merk','$email','$gambar','$alamat')";
...
function ubah($data)
{
    ...
    $sql = "UPDATE siswa SET Merk = '$Merk', tmpt_Lahir = '$tmpt_Lahir', tgl_Lahir = '$tgl_Lahir', jekel = '$jekel', Merk = '$Merk', email = '$email', gambar = '$gambar', alamat = '$alamat' WHERE nis = $nis";
