          ...
          <div class="container">
               ...
               <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav ms-auto">
                         ...
                         <li class="nav-item">
                              <a class="nav-link" href="#Dibuat oleh : ">Dibuat oleh : </a>
                         </li>
                         <li class="nav-item">
          ...
          <div class="row my-2 text-light">
               <div class="col-md">
                    <form action="" method="post" enctype="multipart/form-data">
                         ...
                         <div class="mb-3">
                              <label for="Merk" class="form-label">Jurusan</label>
                              <select class="form-select w-50" id="Merk" name="Merk">
                                   <option disabled selected value>--------------------------------------------Pilih
                                        Jurusan--------------------------------------------</option>
                                   <option value="Iphone" <?php if ($siswa['Merk'] == 'Iphone') { ?>
                                        selected='' <?php } ?>>Iphone</option>
                                   <option value="Samsung"
                                        <?php if ($siswa['Merk'] == 'Samsung') { ?> selected=''
                                        <?php } ?>>Samsung</option>
                                   <option value="Xiaomi" <?php if ($siswa['Merk'] == 'Xiaomi') { ?>
                                        selected='' <?php } ?>>Xiaomi</option>
                              </select>
                         </div>
                         <div class="mb-3">
     ...
     <div class="container-fluid">
          <div class="row bg-dark text-white text-center">
               <div class="col my-2" id="Dibuat oleh : ">
                    ...
                    <p>
                         Ebit Christian Hamonangan Purba (1203012213076)
                    </p>
               </div>
          </div>
     </div>
